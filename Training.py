...
def main(local_rank, num_gpus, args):
    ...
    for epoch in range(args.epochs):
        ...
        for i, data_batch in enumerate(train_loader):
            ...
            images, \
            label_224, label_14, label_28, label_56, label_112, \
            ...
            contour_14, contour_28, contour_56, contour_112 = Variable(contour_14.cuda()), Variable(contour_28.cuda()), \
            ...
            img_total_loss = loss_weights[0] * loss1 + loss_weights[2] * loss3 \
                                + loss_weights[3] * loss4 + loss_weights[4] * loss5
            contour_total_loss = loss_weights[0] * c_loss1 + loss_weights[2] * c_loss3 \
                                + loss_weights[3] * c_loss4 + loss_weights[4] * c_loss5
